    ...
    <div class="container-fluid min-vh-100 d-flex flex-column flex-lg-row align-items-stretch p-0">
        <div class="d-flex flex-column justify-content-start align-items-center flex-1 w-100 min-h-100 bg-white px-3 py-4 p-md-4 p-lg-5">
            <div class="d-flex align-items-center justify-content-between w-100 mb-3">
                ...
                <p id="progress-text">Step 3 of 4</p>
            </div>
            <form action="<?= base_url('verify_credentials') ?>" method="post" class="d-flex flex-column gap-4 w-100 flex-grow-1">
                ...
                <div class="d-felx flex-column justify-content-center align-items-start w-100">
                    <a class="back-button-wrapper" href="<?= base_url('/practitioner_role') ?>">
                ...
                <div class="d-flex flex-column justify-content-start align-items-center gap-4 w-100 h-100 flex-grow-1">
                    <div class="d-flex flex-column justify-content-center align-items-start gap-2 w-100">
                        <h2 class="fw-bold m-0" style="font-family: 'Roboto'; font-size: 36px; line-height:44px; color: #424E79">Define your practice details</h2>
                        <p class="fw-normal m-0" style="font-family: 'Roboto'; font-size: 16px; line-height:24px; color: #424E79">Let patients find and book you by sharing your professional background and preferences.</p>
                    </div>

                    <div class="practitioner-role-input-container">
                        <div class="practitioner-role-input-box-container">
                            <div class="custom-input-wrapper position-relative w-100 mb-3">
                                <button class="w-100 d-flex justify-content-between align-items-center" style="all: unset; cursor: pointer;" type="button" id="professionDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                    <span id="selectedProfession" class="custom-input">Profession</span>
                                ...
                                <ul class="dropdown-menu" aria-labelledby="professionDropdown">
                                    <li><a class="dropdown-item" href="#" onclick="selectValue('Specialized Surgeon', 'Profession')">Specialized Surgeon</a></li>
                                    <li><a class="dropdown-item" href="#" onclick="selectValue('Doctor', 'Profession')">Doctor</a></li>
                                    <li><a class="dropdown-item" href="#" onclick="selectValue('Radiology Technician', 'Profession')">Radiology Technician</a></li>
                                    <li><a class="dropdown-item" href="#" onclick="selectValue('Pediatric Surgeon', 'Profession')">Pediatric Surgeon</a></li>
                                </ul>
                                <input type="hidden" id="professionInput" name="profession" value="">
                            </div>
                            <div class="custom-input-wrapper position-relative w-100">
                                <button class="w-100 d-flex justify-content-between align-items-center" style="all: unset; cursor: pointer;" type="button" id="specializationDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                    <span id="selectedSpecialization" class="custom-input">Specialization</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-caret-down-fill" viewBox="0 0 16 16">
                                        <path d="M7.247 11.14l-4.796-5.481C1.451 5.4 1.99 4.5 2.92 4.5h10.16c.93 0 1.469.9.469 1.159l-4.796 5.481a1 1 0 0 1-1.506 0z" />
                                    </svg>
                                </button>
                                <ul class="dropdown-menu" aria-labelledby="specializationDropdown">
                                    <li><a class="dropdown-item" href="#" onclick="selectValue('Specialized Surgeon', 'Specialization')">Specialized Surgeon</a></li>
                                    <li><a class="dropdown-item" href="#" onclick="selectValue('Doctor', 'Specialization')">Doctor</a></li>
                                    <li><a class="dropdown-item" href="#" onclick="selectValue('Radiology Technician', 'Specialization')">Radiology Technician</a></li>
                                    <li><a class="dropdown-item" href="#" onclick="selectValue('Pediatric Surgeon', 'Specialization')">Pediatric Surgeon</a></li>
                                </ul>
                                <input type="hidden" id="specializationInput" name="specialization" value="">
                            </div>
                        </div>
                        <div class="d-flex flex-column align-items-start gap-2 align-self-stretch">
                            <h3 class="fw-medium" style="color: #424E79; font-family: 'Roboto'; font-size: 16px; line-height: 24px;">Set your booking preference</h3>
                            <div class="option-input-box w-100">
                                <input class="form-check-input option-input-box-icon" type="radio" name="bookingOption" value="yes">
                                <p>Yes! I want to allow patients to book online and schedule consultations directly.</p>
                            </div>

                            <div class="option-input-box w-100">
                                <input class="form-check-input option-input-box-icon" type="radio" name="bookingOption" value="no">
                                <p>No, I prefer to manage my own appointments, but my consultation details will still be visible.</p>
                            </div>
                        </div>
                    </div>
